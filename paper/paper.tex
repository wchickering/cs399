...
We would like to know {\em a priori} the true similarity for a pair of items.
For either true similarity metric, $TrueSim$ is a theoretical construct and not 
something we have access to in the real world. Fortunately, we can achieve good
