...
other datasets, with different types of items and user behavior. Most of the 
assumptions made for this model were not specific to the data used, and so we 
...
We would also like to investigate the use of latent variable
