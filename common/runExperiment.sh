...
LDA_BASE=$DATA/$EXPMT
LDA=${LDA_BASE}.pickle
LDA1=${LDA_BASE}${SEED_EXT}_1.pickle
LDA2=${LDA_BASE}${SEED_EXT}_2.pickle
LSI_BASE=$DATA/$EXPMT
LSI=${LSI_BASE}.npz
LSI1=${LSI_BASE}${SEED_EXT}_1.npz
LSI2=${LSI_BASE}${SEED_EXT}_2.npz
IDFS=$DATA/idfs${CAT}.pickle
TFIDF_BASE=$DATA/tfidf_${EXPMT}
TFIDF=${TFIDF_BASE}.pickle
TFIDF1=${TFIDF_BASE}${SEED_EXT}_1.pickle
TFIDF2=${TFIDF_BASE}${SEED_EXT}_2.pickle
